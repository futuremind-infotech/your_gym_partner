...
<body>
    ...
    <div class="gallery_area">
        ...
        <div class="single_gallery big_img">
            <div class="hover_pop">
                <a class="popup-image" href="img/gallery/7.webp">
                    <i class="ti-plus"></i>
                </a>
            </div>
            <img src="img/gallery/7.webp" alt="">
        </div>
        <div class="single_gallery big_img">
            <div class="hover_pop">
                <a class="popup-image" href="img/gallery/8.webp">
                    <i class="ti-plus"></i>
                </a>
            </div>
            <img src="img/gallery/8.webp" alt="">
        </div>
        <div class="single_gallery big_img">
            <div class="hover_pop">
                <a class="popup-image" href="img/gallery/9.webp">
                    <i class="ti-plus"></i>
                </a>
            </div>
            <img src="img/gallery/9.webp" alt="">
        </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3 ">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <img src="img/logo.png" width="100" alt="Gym Logo">
                                </a>
                            </div>
