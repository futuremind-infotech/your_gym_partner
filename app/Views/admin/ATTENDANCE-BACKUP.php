           ...
           <tbody> 
            ...
            <?php
              ...
              ?>
                ...
                <div class='text-center'><a href='<?php echo site_url("admin/delete-attendance?id=" . $row['user_id']); ?>'><button class='btn btn-danger'>Check Out <i class='icon icon-time'></i></button> </a></div>
                </td>
            ...
            <?php } else {
                ...
                <td><div class='text-center'><a href='<?php echo site_url("admin/check-attendance?id=" . $row['user_id']); ?>'><button class='btn btn-info'>Check In <i class='icon icon-map-marker'></i></button> </a></div></td>
